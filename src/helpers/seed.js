...
const hiragana = [
    ...
    { character: 'ぢゃ', romaji: 'ja', type: 'hiragana' },
    { character: 'ぢゅ', romaji: 'ju', type: 'hiragana' },
    { character: 'ぢょ', romaji: 'jo', type: 'hiragana' },
...
const katakana = [
    ...
    { character: 'ヂャ', romaji: 'ja', type: 'katakana' },
    { character: 'ヂュ', romaji: 'ju', type: 'katakana' },
    { character: 'ヂョ', romaji: 'jo', type: 'katakana' },
...
const seedDB = async () => {
    try {
        ...
        await Character.insertMany(hiragana);
        await Character.insertMany(katakana);
